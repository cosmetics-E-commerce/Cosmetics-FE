...
exports.createAdminSchema = exports.adminPermissionsSchema = exports.updateAdminPermissionsSchema = exports.permissionSchema = exports.permissionKeySchema = void 0;
...
exports.permissionKeySchema = zod_1.z
    .string()
    .regex(/^[a-z_]+:[a-z_]+$/, 'Permission key must be in the form "resource:action"');
...
exports.createAdminSchema = zod_1.z.object({
    ...
    phone: zod_1.z.string().trim().regex(/^01[0125][0-9]{8}$/),
