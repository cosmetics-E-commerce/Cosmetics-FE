...
function validateOtpChannelIdentifier(input, ctx) {
    ...
    if (input.channel === "EMAIL" &&
        !primitives_1.emailSchema.safeParse(input.identifier).success) {
        ctx.addIssue({
            code: zod_1.z.ZodIssueCode.custom,
            path: ["identifier"],
