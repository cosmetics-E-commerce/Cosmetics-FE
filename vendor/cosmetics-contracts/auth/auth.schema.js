...
exports.authSessionSchema =
  ...
  exports.sendEmailVerificationSchema =
  exports.completePasswordChangeSchema =
  exports.verifyPasswordChangeOtpSchema =
  exports.requestPasswordChangeSchema =
  exports.resetPasswordSchema =
  exports.verifyPasswordResetOtpSchema =
  exports.forgotPasswordSchema =
  exports.verifyOtpSchema =
  exports.sendOtpSchema =
  exports.otpPurposeEnum =
  exports.logoutSchema =
  exports.refreshSchema =
  exports.loginSchema =
  exports.createAdminUserSchema =
  exports.resendRegistrationOtpResultSchema =
  exports.registrationVerificationResultSchema =
  exports.resendRegistrationOtpSchema =
  exports.verifyRegistrationEmailSchema =
  exports.registrationOtpChallengeSchema =
  exports.registerSchema =
  exports.createUserSchema =
  exports.otpDeliveryChannelEnum =
    void 0;
...
exports.verifyRegistrationEmailSchema = zod_1.z.object({
  email: primitives_1.emailSchema,
  otp: zod_1.z.string().regex(/^[0-9]{6}$/, "OTP must be a 6-digit code"),
});
exports.resendRegistrationOtpSchema = zod_1.z.object({ email: primitives_1.emailSchema });
exports.registrationVerificationResultSchema = zod_1.z.object({
  verified: zod_1.z.literal(true),
});
exports.resendRegistrationOtpResultSchema = zod_1.z.object({
  ttlSeconds: zod_1.z.number().int().positive(),
  resendAvailableInSeconds: zod_1.z.number().int().nonnegative(),
});
exports.createAdminUserSchema = createUserBaseSchema
  .extend({
    email: primitives_1.emailSchema,
    otpChannel: exports.otpDeliveryChannelEnum.default("EMAIL"),
    /**
...
function validateOtpChannelIdentifier(input, ctx) {
  if (
    input.channel === "SMS" &&
    !primitives_1.egyptPhoneSchema.safeParse(input.identifier).success
  ) {
    ctx.addIssue({
      code: zod_1.z.ZodIssueCode.custom,
      path: ["identifier"],
...
exports.completePasswordChangeSchema = zod_1.z
  .object({
    token: zod_1.z.string().min(32),
  })
  .and(confirmedPasswordSchema);
