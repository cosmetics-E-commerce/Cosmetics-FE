...
exports.paginatedOrderTimelineSchema =
  exports.createOrderResponseSchema =
  exports.orderPaymentInstructionsSchema =
  exports.orderStatisticsSchema =
  exports.paginatedOrdersSchema =
  exports.orderResponseSchema =
  exports.paymentProofResponseSchema =
  exports.invoiceResponseSchema =
  exports.orderCustomerSummarySchema =
  exports.orderTimelineResponseSchema =
  exports.orderItemResponseSchema =
  exports.orderQuerySchema =
  exports.updateOrderStatusSchema =
  exports.rejectPaymentProofSchema =
  exports.uploadPaymentProofSchema =
  exports.cancelOrderSchema =
  exports.checkoutOrderSchema =
  exports.createOrderSchema =
  exports.orderItemInputSchema =
    void 0;
...
exports.orderQuerySchema = pagination_1.paginationQuerySchema.extend({
  ...
  sortBy: zod_1.z.enum(["placedAt", "updatedAt", "grandTotal", "orderNumber"]).default("placedAt"),
});
...
exports.orderResponseSchema = zod_1.z.object({
  ...
  appliedPromotions: zod_1.z.array(
    zod_1.z.object({
...
exports.paginatedOrdersSchema = (0, pagination_1.paginated)(
  exports.orderResponseSchema.omit({ items: true }),
);
