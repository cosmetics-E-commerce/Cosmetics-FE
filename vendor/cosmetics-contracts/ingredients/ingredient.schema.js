...
exports.ingredientImportRowSchema = exports.ingredientExternalQuerySchema = exports.barcodeSchema = exports.parseIngredientListSchema = exports.ingredientResponseSchema = exports.ingredientSummarySchema = exports.productIngredientInputSchema = exports.ingredientQuerySchema = exports.updateIngredientSchema = exports.createIngredientSchema = exports.ingredientInputSchema = exports.ingredientSourceSchema = void 0;
...
exports.ingredientQuerySchema = pagination_1.paginationQuerySchema.extend({
    ...
    sortBy: zod_1.z
        .enum(["inciName", "commonName", "createdAt", "updatedAt"])
        .default("inciName"),
});
