import { z } from "zod";
export declare const skinTypeEnum: z.ZodEnum<
...
export declare const createProductSchema: z.ZodEffects<
  z.ZodObject<
    {
      ...
      skinType: z.ZodDefault<
        z.ZodArray<z.ZodEnum<["OILY", "DRY", "COMBINATION", "SENSITIVE", "NORMAL", "ALL"]>, "many">
      >;
...
export declare const productVariantUpdateSchema: z.ZodUnion<
  [
    z.ZodObject<
      {
        sku: z.ZodString;
...
export declare const receiveBatchSchema: z.ZodEffects<
  z.ZodEffects<
    z.ZodObject<
      {
...
export declare const publicCatalogQuerySchema: z.ZodEffects<
  z.ZodObject<
    {
      ...
      skinType: z.ZodEffects<
        z.ZodOptional<
          z.ZodArray<
            z.ZodEnum<["OILY", "DRY", "COMBINATION", "SENSITIVE", "NORMAL", "ALL"]>,
            "many"
          >
        >,
        ("OILY" | "DRY" | "COMBINATION" | "SENSITIVE" | "NORMAL" | "ALL")[] | undefined,
        unknown
      >;
...
export declare const adminProductQuerySchema: z.ZodEffects<
  z.ZodObject<
    {
      page: z.ZodDefault<z.ZodNumber>;
      limit: z.ZodDefault<z.ZodNumber>;
...
export declare const updateCategorySchema: z.ZodEffects<
  z.ZodObject<
    {
...
export declare const updateBrandSchema: z.ZodEffects<
  z.ZodObject<
    {
      slug: z.ZodOptional<z.ZodString>;
