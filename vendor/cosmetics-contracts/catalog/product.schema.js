...
exports.adminProductSchema = exports.adminProductImageSchema = exports.adminProductVariantSchema = exports.publicProductSchema = exports.publicProductVariantSchema = exports.publicProductImageSchema = exports.createBrandSchema = exports.publicBrandListItemSchema = exports.publicBrandSchema = exports.createCategorySchema = exports.publicCategorySchema = exports.adminProductQuerySchema = exports.publicBrandQuerySchema = exports.publicCatalogQuerySchema = exports.receiveBatchSchema = exports.updateProductSchema = exports.productVariantUpdateSchema = exports.createProductSchema = exports.productImageInputSchema = exports.productVariantInputSchema = exports.skinTypeEnum = void 0;
...
exports.publicCatalogQuerySchema = pagination_1.paginationQuerySchema.extend({
...
exports.adminProductQuerySchema = pagination_1.paginationQuerySchema.extend({
    search: zod_1.z.string().trim().min(1).max(120).optional(),
...
exports.publicProductVariantSchema = zod_1.z.object({
    id: primitives_1.uuidSchema,
    sku: zod_1.z.string(),
    nameEn: zod_1.z.string(),
    nameAr: zod_1.z.string(),
...
exports.adminProductVariantSchema = exports.publicProductVariantSchema.extend({
