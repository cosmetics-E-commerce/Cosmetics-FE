...
export declare const businessAnalyticsQuerySchema: z.ZodObject<
  {
    ...
    range: z.ZodDefault<
      ...
      >
    >;
    compare: z.ZodDefault<
      z.ZodEnum<["none", "previous_period", "previous_week", "previous_month", "previous_year"]>
    >;
  ...
  },
  {
    ...
    customerType?: "all" | "returning" | "new" | "guest" | "registered" | undefined;
    range?:
      | "all"
      | "7d"
      | "30d"
    ...
    to?: string | undefined;
    compare?:
      "none" | "previous_period" | "previous_week" | "previous_month" | "previous_year" | undefined;
...
>;
export declare const commerceEventNames: readonly [
  "product_viewed",
          ...
          z.ZodObject<
            {
              id: z.ZodString;
              type: z.ZodEnum<
                ["KPI", "LINE", "BAR", "TABLE", "HEATMAP", "FUNNEL", "RANKING", "INSIGHTS"]
              >;
              title: z.ZodString;
              metric: z.ZodString;
