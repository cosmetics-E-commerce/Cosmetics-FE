...
exports.analyticsDashboardSchema = exports.savedViewSchema = exports.commerceEventSchema = exports.commerceEventNames = exports.businessAnalyticsQuerySchema = void 0;
...
exports.businessAnalyticsQuerySchema = zod_1.z.object({
    ...
    customerType: zod_1.z
        .enum(["all", "new", "returning", "guest", "registered"])
        .default("all"),
