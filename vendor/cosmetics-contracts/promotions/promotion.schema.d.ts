...
export declare const promotionResolvedStatusEnum: z.ZodEnum<
...
export declare const promotionConditionSchema: z.ZodDiscriminatedUnion<
  "type",
  [
    z.ZodObject<
      {
...
export declare const promotionActionSchema: z.ZodDiscriminatedUnion<
  "type",
  [
    z.ZodObject<
      {
...
>;
export declare const promotionLimitsSchema: z.ZodDefault<
  z.ZodObject<
    {
  ...
  >
>;
export declare const promotionDisplaySchema: z.ZodDefault<
  z.ZodObject<
    {
  ...
  >
>;
export declare const couponConfigurationSchema: z.ZodOptional<
  z.ZodObject<
    {
  ...
  >
>;
export declare const createPromotionSchema: z.ZodEffects<
  z.ZodObject<
    {
      name: z.ZodString;
              ...
              z.ZodObject<
                {
                  type: z.ZodLiteral<"CUSTOMER_TYPE">;
                  value: z.ZodEnum<
                    ["EVERYONE", "AUTHENTICATED", "GUEST", "FIRST_ORDER", "RETURNING", "VIP"]
                  >;
                },
                "strip",
                z.ZodTypeAny,
...
export declare const promotionQuerySchema: z.ZodObject<
  {
    ...
    status: z.ZodOptional<
      z.ZodEnum<["DRAFT", "SCHEDULED", "ACTIVE", "PAUSED", "EXPIRED", "EXHAUSTED", "ARCHIVED"]>
    >;
    trigger: z.ZodOptional<z.ZodEnum<["AUTOMATIC", "CODE"]>>;
    sortBy: z.ZodDefault<
      z.ZodEnum<["createdAt", "updatedAt", "priority", "startsAt", "usedCount"]>
    >;
  },
  "strip",
  z.ZodTypeAny,
      ...
      z.ZodObject<
        ...
        z.ZodTypeAny,
        {
          type:
            ...
            | "FLASH_SALE";
          status:
            "ACTIVE" | "EXPIRED" | "ARCHIVED" | "DRAFT" | "PAUSED" | "SCHEDULED" | "EXHAUSTED";
          id: string;
          createdAt: string;
          updatedAt: string;
          summary: string;
