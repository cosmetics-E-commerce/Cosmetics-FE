 ...
 */
export declare const PaymentMethodEnum: z.ZodEnum<["VODAFONE_CASH", "INSTAPAY", "CASH_ON_DELIVERY", "COD", "CARD"]>;
...
export declare const OrderStatusEnum: z.ZodEnum<["PENDING_PAYMENT", "AWAITING_PAYMENT", "PAYMENT_REVIEW", "PAYMENT_FAILED", "PAID", "CONFIRMED", "PROCESSING", "READY_TO_SHIP", "READY_FOR_SHIPPING", "SHIPPED", "IN_TRANSIT", "OUT_FOR_DELIVERY", "DELIVERED", "RETURNED", "CANCELLED", "REFUNDED", "FAILED"]>;
