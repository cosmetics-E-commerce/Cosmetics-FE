...
exports.bilingualTextSchema =
  exports.instapayAddressSchema =
  exports.idempotencyKeySchema =
  exports.slugSchema =
  exports.emailSchema =
  exports.egyptPhoneSchema =
  exports.piastresSchema =
  exports.uuidSchema =
    void 0;
 ...
 * See PLAN.md §6.2.
 */
exports.idempotencyKeySchema = zod_1.z.string().uuid("Idempotency-Key must be a valid UUID");
