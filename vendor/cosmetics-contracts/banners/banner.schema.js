...
exports.analyticsQuerySchema = exports.bannerTemplateSchema = exports.bannerSettingsSchema = exports.activeBannerQuerySchema = exports.bannerEventSchema = exports.reorderBannersSchema = exports.bannerQuerySchema = exports.updateBannerSchema = exports.createBannerSchema = exports.recurringScheduleSchema = exports.bannerResponsiveSchema = exports.bannerTargetingSchema = exports.bannerBehaviorSchema = exports.bannerAnimationSchema = exports.bannerDesignSchema = exports.bannerMessageSchema = exports.bannerDisplayStrategySchema = exports.bannerStatusSchema = exports.bannerPositionSchema = exports.bannerStateSchema = exports.bannerModeSchema = void 0;
const zod_1 = require("zod");
const color = zod_1.z
    .string()
    .trim()
    .regex(/^#[0-9a-f]{6}$/i, "Use a six-digit hex color");
const nullableDate = zod_1.z
    .string()
...
exports.bannerStateSchema = zod_1.z.enum([
    "DRAFT",
    "ACTIVE",
    "PAUSED",
    "ARCHIVED",
...
exports.bannerBehaviorSchema = zod_1.z.object({
    ...
    successMessageEn: zod_1.z
        .string()
        .trim()
        .max(300)
        .default("YOU'VE UNLOCKED FREE SHIPPING"),
    successMessageAr: zod_1.z
        .string()
        .trim()
        .max(300)
        .default("لقد حصلت على التوصيل المجاني"),
...
exports.createBannerSchema = zod_1.z
    ...
    if (value.behavior.freeShippingThresholdSource === "CUSTOM" &&
...
exports.bannerQuerySchema = zod_1.z.object({
    ...
    sort: zod_1.z
        .enum(["priority", "updatedAt", "startsAt", "name"])
        .default("priority"),
