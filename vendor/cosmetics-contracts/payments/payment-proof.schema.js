...
exports.paginatedPaymentsSchema = exports.paymentStatisticsSchema = exports.paymentMethodAvailabilitySchema = exports.paymentResponseSchema = exports.paymentProofSummaryResponseSchema = exports.paymentCustomerResponseSchema = exports.paymentHistoryResponseSchema = exports.paymentAttachmentResponseSchema = exports.paymentInstructionsResponseSchema = exports.paymentQuerySchema = exports.refundPaymentSchema = exports.rejectPaymentSchema = exports.verifyPaymentSchema = exports.proofUploadRequestSchema = exports.uploadPaymentProofFileSchema = exports.submitPaymentProofSchema = exports.createPaymentSchema = exports.manualPaymentMethodSchema = void 0;
...
exports.submitPaymentProofSchema = zod_1.z.object({
    ...
    proofImageKey: zod_1.z
        .string()
        .trim()
        .min(1, "Upload a screenshot of the transfer"),
...
exports.paymentCustomerResponseSchema = zod_1.z.object({
    id: primitives_1.uuidSchema,
...
exports.paymentProofSummaryResponseSchema = zod_1.z.object({
    id: primitives_1.uuidSchema,
    senderRef: zod_1.z.string(),
    txnReference: zod_1.z.string(),
    amountClaimed: zod_1.z.number().int(),
...
exports.paymentResponseSchema = zod_1.z.object({
    ...
    customer: exports.paymentCustomerResponseSchema.nullable().optional(),
    latestProof: exports.paymentProofSummaryResponseSchema.nullable().optional(),
...
exports.paymentStatisticsSchema = zod_1.z.object({
    ...
    revenueByMethod: zod_1.z.array(zod_1.z.object({ method: enums_1.PaymentMethodEnum, revenue: zod_1.z.number().int() })),
    revenueByDay: zod_1.z.array(zod_1.z.object({ date: zod_1.z.string(), revenue: zod_1.z.number().int() })),
});
